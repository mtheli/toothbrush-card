...
| Laifen | [`laifen_ble`](https://github.com/UrbanTechIO/Laifen) (custom component) | 🧪 | Live timer, time-based sectors (aligned with the handle's 30s pacer when enabled), mode, battery and (Wave Pro) pressure — implemented for Wave and Wave Pro, not yet verified on real hardware; test reports welcome ([#9](https://github.com/mtheli/toothbrush-card/issues/9)) |
