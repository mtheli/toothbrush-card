...
const $de15c9db4b7b9358$export$17b81730949de002 = "2026-08-16T06:40Z";
...
class $930552a63f9e9686$export$e2f41388bb2b94a0 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
    ...
    render() {
        ...
        if (latch.loadHistoryRecap) // Deliberately the raw entity reading, not `routineLength`: its
        ...
        this._maybeLoadRecapFromHistory(hass, config, entityIds, Math.round(routineFromEntity));
...
class $2e9f76afc74d559a$export$eec44ce80a6d3e24 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
    ...
    _hasVerdictSource() {
        if (!this.hass || !this._config?.device_id) return false;
        return Object.values(this.hass.entities).some((e)=>e.device_id === this._config.device_id && (e.translation_key === 'smiley' || e.entity_id.endsWith('_score')));
    }
    _fireConfig(config) {
