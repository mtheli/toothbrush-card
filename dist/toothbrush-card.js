...
class $930552a63f9e9686$export$e2f41388bb2b94a0 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
    ...
    render() {
        ...
        const pressure = metricUnavailable ? "\u2013" : rawPressure === 'on' || rawPressure === 'too_high' ? 'high' : rawPressure === 'off' || rawPressure === 'ok' || rawPressure === 'optimal' ? 'normal' : rawPressure;
        ...
        if (active) {
            ...
            if (!this._completed) this._completedAt = Date.parse(hass.states[entityIds.duration]?.last_changed) || Date.now();
            ...
            <ha-card style="${this._cardStyle()}">
                ...
                <div class="chips-row">
                    ...
                    <div class="chip" @click="${()=>this._showMoreInfo(metricEntity)}">
                        ${isIntensity ? (0, $d33ef1320595a3ac$export$c0bb0b647f701bb5)`
    ...
    static getStubConfig(hass) {
        const entry = Object.values(hass.entities).find((e)=>e.translation_key && $930552a63f9e9686$export$1a6ef95039f86f17[e.platform] === e.translation_key);
        return {
...
class $2e9f76afc74d559a$export$eec44ce80a6d3e24 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
    ...
    _deviceOptions() {
        ...
        for(const entityId in this.hass.entities){
            ...
            const requiredKey = (0, $930552a63f9e9686$export$1a6ef95039f86f17)[entity.platform];
