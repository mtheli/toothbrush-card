...
class $930552a63f9e9686$export$e2f41388bb2b94a0 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
     ...
     */ _intensityStep(intensity) {
        ...
        if (!Number.isFinite(n)) // A named level sits at the bottom, middle or top of the scale.
        return ({
            low: 1,
            medium: 3,
            high: 5
