...
const $de15c9db4b7b9358$export$17b81730949de002 = "2026-08-13T05:56Z";
                ...
                <div class="card-header">
                    ...
                    <div class="header-icons">
                        <svg class="conn-icon ${btActive ? 'active' : ''} ${!btConnected ? 'disconnected' : ''}"
                            ...
                            <path d="${btActive ? (0, $3cb0a15594fd43d6$export$cd21dc7a72bbb52c).bluetooth_transfer : (0, $3cb0a15594fd43d6$export$cd21dc7a72bbb52c).bluetooth}"/>
                        </svg>
