...
const $de15c9db4b7b9358$export$17b81730949de002 = "2026-07-22T01:13Z";


const $930552a63f9e9686$export$d5e7ce6d07daf10f = "0.27.0";
...
class $930552a63f9e9686$export$e2f41388bb2b94a0 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
    ...
    render() {
        ...
        } else if (holdCompleted && !this._holdDismissed && !this._completed && config.history_recap !== false && (!entityIds.routine_length || routineLength > 0) && entityIds.duration) // Issue #11: Oral-B wipes the reported session values ~seconds
        ...
        this._maybeLoadRecapFromHistory(hass, config, entityIds, routineLength || $930552a63f9e9686$var$BRUSHING_DURATION);
