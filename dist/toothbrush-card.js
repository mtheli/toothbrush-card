    ...
    render() {
        ...
        const chipEl = (prop)=>{
            switch(prop){
                ...
                case 'mode':
                    ...
                    return (0, $d33ef1320595a3ac$export$c0bb0b647f701bb5)`<div class="chip mode-chip-wrap ${canSelectMode ? 'selectable' : ''}" @click="${()=>this._handleModeChipClick()}">
        ...
        return (0, $d33ef1320595a3ac$export$c0bb0b647f701bb5)`
            <ha-card style="${this._cardStyle()}">
                ...
                ${chipEls.length ? (0, $d33ef1320595a3ac$export$c0bb0b647f701bb5)`<div class="chips-row${chipEls.length === 4 ? ' four-chips' : ''}">${chipEls}</div>` : ''}
