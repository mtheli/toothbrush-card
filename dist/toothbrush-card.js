...
const $de15c9db4b7b9358$export$17b81730949de002 = "2026-08-10T11:36Z";


const $930552a63f9e9686$export$d5e7ce6d07daf10f = "0.28.0-beta.2";
...
function $930552a63f9e9686$export$23f5d0f4bf90bc55(hass, deviceId) {
    ...
    for(const entityId in allEntities){
        ...
        if (entity.platform === 'laifen_ble') {
            ...
            } else if (match('number', 'brushing_duration', '_brushing_duration') && entityKeys.routine_length === null) {
...
class $930552a63f9e9686$export$e2f41388bb2b94a0 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
    ...
    async _maybeLoadRecapFromHistory(hass, config, entityIds, routineTarget) {
        ...
        const target = this._routineAtFromHistory(routineRows, session.endedAt, entityIds) || routineTarget || (entityIds.routine_length ? 0 : $930552a63f9e9686$var$BRUSHING_DURATION);
        if (!target) return;
    ...
    _routineAtFromHistory(rows, endedAt, entityIds) {
        ...
        for (const row of rows){
            ...
            if (Number.isFinite(v) && v > 0) seconds = Math.round(v * (entityIds.routine_length_minutes ? 60 : 1));
        }
        return seconds;
    }
    connectedCallback() {
