...
function $b973a26f761c9c78$export$912b1850c5c72a40(prev, { active: active, duration: duration, routineLength: routineLength, now: now, holdCompleted: holdCompleted, hasRoutineEntity: hasRoutineEntity = false, hasDurationEntity: hasDurationEntity = false, historyRecapEnabled: historyRecapEnabled = true, durationLastChanged: durationLastChanged = null, displayFace: displayFace = null, displayScore: displayScore = null, faceWindow: faceWindow = false }) {
    const state = {
        ...prev
    };
    ...
    if (faceWindow && displayFace && displayFace !== 'off' && displayFace !== 'unknown' && displayFace !== 'unavailable') state.face = displayFace;
...
const $de15c9db4b7b9358$export$17b81730949de002 = "2026-08-16T22:34Z";
...
const $930552a63f9e9686$export$77013d0794c47302 = new Set([
    'session_summary',
...
class $930552a63f9e9686$export$e2f41388bb2b94a0 extends (0, $528e4332d1e3099e$export$3f2f9f5909897157) {
    ...
    _recapFromLastSession(hass, config, entityIds, routineFromEntity, notBefore = 0) {
        ...
        if (notBefore && endedAt < notBefore - 60000) return false;
        ...
        const target = Number(config.routine_length) || Number(attrs.routine_length_seconds) || routineFromEntity || (entityIds.routine_length || entityIds.routine_length_number ? 0 : (0, $b973a26f761c9c78$export$918b2e620e4fca36));
    ...
    render() {
        ...
        const latch = (0, $b973a26f761c9c78$export$912b1850c5c72a40)(this._sessionState(), {
            ...
            faceWindow: active || $930552a63f9e9686$export$77013d0794c47302.has(statusSlug),
        ...
        if (latch.loadHistoryRecap) {
            ...
            if (!this._recapFromLastSession(hass, config, entityIds, target)) this._maybeLoadRecapFromHistory(hass, config, entityIds, target);
        } else if (this._completed && this._completedSource !== 'device' && entityIds.last_session) // A session the card watched end, on a handle that files a record
        ...
        const completedAtLabel = showRecap && this._completedAt > 0 ? new Date(this._completedAt).toLocaleString(hass.locale?.language || hass.language || undefined, {
            dateStyle: 'medium',
            timeStyle: 'short'
        }) : '';
        ...
        const ownVerdict = showVerdict && this._completedSource === 'device' && !this._completedFace && !Number.isFinite(parseFloat(this._completedScore)) && this._completedDuration > 0 ? (()=>{
            ...
            const pressed = this._completedPressure > 0 ? this._completedPressure / this._completedDuration : 0;
