...
/* Zahn-Stil und Animation */
.cleaning .surfaces {
  stroke: #ccc;
  stroke-width: 3;
  filter: url(#shadow);
  animation: blinkTooth 1s infinite ease-in-out;
}
...
.cleaning .plaque {
  ...
  stroke-width: 3;
  filter: url(#shadow);
  animation: blinkPlaque 1s infinite ease-in-out;
}
...
.cleaned .plaque {
  fill: none;
     ...
     id="g22">
    <g
   id="g1" class="upper_right ${classMap(sectorClassData.upper_right)}"
   inkscape:label="upper_right"><path
     ...
     style="display:inline"><path
       ...
       id="path11" /></g></g><g
   id="g2" class="upper_left ${classMap(sectorClassData.upper_left)}"
   inkscape:label="upper_left"><path
     ...
     inkscape:label="upper_left_slots"><path
       ...
       id="path10" /></g></g><g
   id="g3" class="lower_left ${classMap(sectorClassData.lower_left)}"
   inkscape:label="lower_left"><path
     ...
     inkscape:label="lower_left_slots"><path
       ...
       id="path22" /></g></g><g
   id="g4" class="lower_right ${classMap(sectorClassData.lower_right)}"
